...
from yolov7_pose_estimation.utils.google_utils import gsutil_getsize
from yolov7_pose_estimation.utils.metrics import fitness
from yolov7_pose_estimation.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(device='cpu',f='yolov7-w6-pose.pt', s=''):  # from utils.general import *; strip_optimizer()
    ...
    x = torch.load("Models/yolov7/"+f, map_location=torch.device('cpu'))
    if x.get('ema'):
